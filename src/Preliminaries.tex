...
%When we design custom IP in Vivado, there are three types of register we can choose, Lite,Full and Stream. These three types is %based on AXI4 protocol,  
%\begin{itemize}
